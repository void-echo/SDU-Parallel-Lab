...
static INLINE void sniff_object_array() {
    ...
    // it does not print all combinations, but only print the first 10 and
    // the last 10 pivot combinations. It is useful when n is large, and m
    // is small. print first 10 elements in the object array
